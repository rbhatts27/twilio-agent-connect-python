...
- Centralized logging setup in tac/core/logging.py
- Python-dotenv support for loading .env files in webhook server
- .env.example file with sample environment variables
- Logging throughout TAC core, Maestro, and Memora clients

### Changed
- Made TACConfig fields required for better validation
...
### Added
- Environment variable support for TAC configuration
...
- Simplified webhook handler by removing unnecessary TAC null check
...
### Fixed
- Updated test suite to match actual TACConfig field names
- Fixed deprecated Pydantic v1 method usage in tests

## [0.1.0] - 2025-09-17

### Added
- Initial release of Twilio Agent Connect
