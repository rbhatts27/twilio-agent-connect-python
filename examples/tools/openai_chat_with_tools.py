...
async def main() -> None:
    ...
    # TWILIO_TAF_KNOWLEDGE_IDS should be a comma-separated list of knowledge IDs (e.g., "KN123,KN456")
    ...
    client = AsyncOpenAI(api_key=os.environ.get("TWILIO_TAF_OPENAI_API_KEY"))
