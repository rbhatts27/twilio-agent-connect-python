"""Structured logging configuration for the Twilio Agentic Framework."""
...
def setup_logging(log_level: str = "INFO", log_format: str = "json") -> logging.Logger:
    """
    Configure structured logging for TAF framework.
...
def get_logger(name: str, **context: Any) -> ContextLogger:
    ...
    base_logger = logging.getLogger(f"taf.{name}")
