...
class TAFTool:
    ...
    def implementation(self) -> Callable[..., Awaitable[object]]:
        ...
        Returns an async callable since TAF is async-first.
        ...
        async def tool_callable(*args: object, **kwargs: object) -> object:
            """Clean async callable that forwards to TAFTool.__call__()"""
    ...
    def configure_injection(self, **kwargs: object) -> "TAFTool":
        """
        ...
        Example:
            tool.configure_injection(client=memory_client, config=taf_config)
        """
...
def function_tool(
...
) -> Callable[[Callable[..., object]], TAFTool]:
    """
    ...
    def decorator(func: Callable[..., object]) -> TAFTool:
